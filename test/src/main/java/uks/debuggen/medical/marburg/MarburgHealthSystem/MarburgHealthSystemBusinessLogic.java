...
public class MarburgHealthSystemBusinessLogic
{
   ...
   private void handleDemoLoadDiseasesCommand(LoadDiseasesCommand event)
   {
      if (event.getId().equals("12:00")) {
         ...
         SymptomBuilt mediumFeverdEvent = new SymptomBuilt();
         mediumFeverdEvent.setId("12:00:07");
         mediumFeverdEvent.setBlockId("mediumFeverd");
         mediumFeverdEvent.setName("medium feverd");
         service.apply(mediumFeverdEvent);
