...
public class TestDoneEvent extends Event
{
   ...
   public TestDoneEvent setTest(String value)
   {
   ...
   public TestDoneEvent setResult(String value)
   {
   ...
   public TestDoneEvent setConsultation(String value)
   {
