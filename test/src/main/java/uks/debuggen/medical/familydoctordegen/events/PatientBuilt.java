...
public class PatientBuilt extends DataEvent
{
   ...
   public PatientBuilt setName(String value)
   {
   ...
   public PatientBuilt setAddress(String value)
   {
   ...
   public PatientBuilt setBirthDate(String value)
   {
