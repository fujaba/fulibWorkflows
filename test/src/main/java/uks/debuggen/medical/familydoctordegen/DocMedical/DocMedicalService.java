...
public class DocMedicalService
{
   ...
   public DocMedicalService setHistory(LinkedHashMap<String, Event> value)
   {
   ...
   public DocMedicalService setPort(int value)
   {
      if (value == this.port)
      {
         return this;
   ...
   public DocMedicalService setSpark(Service value)
   {
   ...
   public DocMedicalService setModel(DocMedicalModel value)
   {
   ...
   public DocMedicalService setBusinessLogic(DocMedicalBusinessLogic value)
   {
   ...
   public DocMedicalService setBuilder(DocMedicalBuilder value)
   {
