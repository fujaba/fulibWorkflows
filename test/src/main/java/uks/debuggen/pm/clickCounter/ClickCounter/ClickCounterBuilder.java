...
public class ClickCounterBuilder
{
   ...
   private ClickCounterBusinessLogic businessLogic;
   ...
   public ClickCounterBuilder setModel(ClickCounterModel value)
   {
   ...
   public ClickCounterBuilder setEventStore(LinkedHashMap<String, DataEvent> value)
   {
   ...
   public ClickCounterBuilder setLoaderMap(LinkedHashMap<Class, Function<Event, Object>> value)
   {
   ...
   public ClickCounterBuilder setGroupStore(LinkedHashMap<String, LinkedHashMap<String, DataEvent>> value)
   {
   ...
   public ClickCounterBusinessLogic getBusinessLogic()
   {
      return this.businessLogic;
   }

   public ClickCounterBuilder setBusinessLogic(ClickCounterBusinessLogic value)
   {
      ...
      final ClickCounterBusinessLogic oldValue = this.businessLogic;
   ...
   public ClickCounterBuilder setService(ClickCounterService value)
   {
   ...
   public void storeCounterBuilt(Event e)
   {
      CounterBuilt event = (CounterBuilt) e;
      if (outdated(event)) {
         return;
      }
   ...
   public Counter loadCounterBuilt(Event e)
   {
      CounterBuilt event = (CounterBuilt) e;
