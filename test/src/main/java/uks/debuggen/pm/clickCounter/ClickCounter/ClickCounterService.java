...
public class ClickCounterService
{
   ...
   public ClickCounterService setHistory(LinkedHashMap<String, Event> value)
   {
   ...
   public ClickCounterService setPort(int value)
   {
      if (value == this.port)
      {
         return this;
   ...
   public ClickCounterService setSpark(Service value)
   {
   ...
   public ClickCounterService setModel(ClickCounterModel value)
   {
   ...
   public ClickCounterService setBusinessLogic(ClickCounterBusinessLogic value)
   {
   ...
   public ClickCounterService setBuilder(ClickCounterBuilder value)
   {
