...
public class ChargingApprovedEvent extends Event
{
   ...
   public ChargingApprovedEvent setRequestId(String value)
   {
   ...
   public ChargingApprovedEvent setChargerId(String value)
   {
   ...
   public ChargingApprovedEvent setPower(String value)
   {
   ...
   public ChargingApprovedEvent setInterval(String value)
   {
