...
public class StoreBoxCommand extends Command
{
   ...
   public StoreBoxCommand setBox(String value)
   {
   ...
   public StoreBoxCommand setProduct(String value)
   {
   ...
   public StoreBoxCommand setPlace(String value)
   {
