...
public class PickOrderCommand extends Command
{
   ...
   public PickOrderCommand setPickTask(String value)
   {
   ...
   public PickOrderCommand setBox(String value)
   {
   ...
   public PickOrderCommand setUser(String value)
   {
