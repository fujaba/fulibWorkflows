...
//      pre.shouldHave(matchText("symptoms:.*cough, medium fever, chills, joint pain, headache, lung noises"));
   ...
   public void HealthExperts()
   {
      ...
      pre.shouldHave(text("- commonCold:"));
      pre.shouldHave(matchText("name:.*\"common cold\""));
      pre.shouldHave(matchText("symptoms:.*runnyNose.*cough.*hoarseness.*mediumFever.*"));
      pre.shouldHave(matchText("counterSymptoms:.*chills.*jointPain.*"));
      // check data note 12:00:02
      pre = $("#data");
      pre.shouldHave(text("- influenza:"));
      pre.shouldHave(matchText("name:.*influenza"));
      pre.shouldHave(matchText("symptoms:.*cough.*mediumFever.*chills.*jointPain.*headache.*"));
      pre.shouldHave(matchText("counterSymptoms:.*lungNoises.*"));
      // check data note 12:00:03
      pre = $("#data");
      pre.shouldHave(text("- pneumonia:"));
      pre.shouldHave(matchText("name:.*pneumonia"));
      pre.shouldHave(matchText("symptoms:.*cough.*mediumFever.*chills.*jointPain.*headache.*lungNoises.*"));
      ...
      pre = $("#data");
      pre.shouldHave(text("- lungNoises:"));
