...
## General
There are a few [general](general.md) definitions that are used to structure the generated html file. These do not have any functionality in the generated implementation besides the name of a few files.
...
* [General](general.md)
* [Event Modelling / Service](eventModelling_service.md)
* [GUI](gui.md)
* [Model](model.md)